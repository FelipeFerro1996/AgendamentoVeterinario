        ...
        <div class="row justify-content-md-center">
            <div class="col-md-12">
                    <div class="row">
                        ...
                        <div class="col-md-2">
                            <label for="data" class="pt-2" >Selecione Uma Mes:</label>
                        </div>
                        <div class="col-md-3">
                            <input type="month" class="form-control" name="date" min="<?=date('Y')?>-<?=date('m')?>" id="dataSel">
                        </div>
                        <div class="col-md-2">
                            <button type="button" class="btn btn-primary mb-3" id="buscarAgendamentos">Buscar</button>
                        </div>
