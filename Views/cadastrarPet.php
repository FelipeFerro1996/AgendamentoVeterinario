    ...
    <section id="conteudo" class="bg-info"><!--Inicio seção Conteudo-->
      <div class="container">
        ...
        <div class="row justify-content-md-center">
            <div class="col-md-12">
                <form method="post" action="../controller/PetsController.php?acao=inserir">
                    ...
                    <div class="row justify-content-md-center">
                        ...
                        <div class="col-3">
                            <select class="form-control" name="especie">
                                <option vlaue="cachorro">Cachorro</option>
                                <option vlaue="gato">Gato</option>
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="row justify-content-md-center">
                        <div class="col-3">
                            <input type="text" name="raca" class="form-control" id="raca" placeholder="Raça:" required>
                        </div>
                        <div class="col-3">
                            <select class="form-control" name="porte">
                                <option vlaue="pequeno">Pequeno</option>
                                <option vlaue="medio">Médio</option>
                                <option vlaue="grande">Grande</option>
                            </select>
                        </div>
                        <div class="col-3">
